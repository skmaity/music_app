...
Future<List<double>> getImageSize(String imageUrl) async {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: FutureBuilder(future: getImageSize(imageurl), builder: (context, snapshot) {
          // print(snapshot.data);
...
return  ImageColors(
        title: 'Image Colors',
        // image: const AssetImage('assets/agartumsathho.jpg'),
